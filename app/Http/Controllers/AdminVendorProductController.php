...
class AdminVendorProductController extends Controller
{
    ...
    public function updateVendorPro(Request $request, $id)
    {
      $request->validate([
    ...
    public function addVendorPro()
    {
      return view('backend.seller.products.add_product');
    }

    public function postVendorPro(Request $request)
    {
      $request->validate([
        'pro_name' => 'required|max:255|min:2',
        'pro_generic_name' => 'required',
