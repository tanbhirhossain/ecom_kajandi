                ...
                @foreach($show_faq as $faq)
                    <article class="product-page-qa">
                        <div class="product-page-qa-question">
                            <p class="product-page-qa-text">Question</p>
                            <p class="product-page-qa-meta">asked by User Name on TIme</p>
                        </div>
                        <div class="product-page-qa-answer">
                            <p class="product-page-qa-text">Answer</p>
                            <p class="product-page-qa-meta">answered on </p>
                        </div>
                    </article>
                @endforeach
