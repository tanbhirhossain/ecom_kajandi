                    ...
                    <div class="card-body">
                        ...
                        <div class="card-body card-block">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="company" name="vendorname"  class="form-control" value="@if($editVendor != Null){{$editVendor->vendorname}} @endif" placeholder="Enter Vendor/Seller Name">
                            ...
                            <div class="row">
                                <div class="col-md-4 form-group">
                                    ...
                                    <select class="form-control" name="vendor_type">
                                        <option value="@if($editVendor != Null){{$editVendor->vendor_type}} @endif" option="selected">
                                            <?php
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <select class="form-control" name="producttype">
                                        <option value="@if($editVendor != Null){{$editVendor->producttype}} @endif" option="selected">
                                            <?php
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="address" name="address"  class="form-control" value="@if($editVendor != Null){{$editVendor->address}} @endif" placeholder="Enter address">
                                @if ($errors->has('name'))
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" id="url" name="url"  class="form-control" value="@if($editVendor != Null){{$editVendor->url}} @endif" placeholder="Enter Website/URL">
                                @if ($errors->has('url'))
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" id="cac" name="cac"  class="form-control" value="@if($editVendor != Null){{$editVendor->cac}} @endif" placeholder="Enter CAC Number">
                                    @if ($errors->has('cac'))
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" id="workforce" name="workforce"  class="form-control" value="@if($editVendor != Null){{$editVendor->workforce}} @endif" placeholder="Enter Workforce">
                            ...
                            <div class="row">
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" id="yearsofexp" name="yearsofexp"  class="form-control" value="@if($editVendor != Null){{$editVendor->yearsofexp}} @endif"  placeholder="Enter Years of Experience">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <select class="form-control" name="ratings">
                                        <option value="@if($editVendor != Null){{$editVendor->ratings}} @endif" option="selected">
                                            <?php
                        ...
                        <div class="card-body">
                            <div class="card-body card-block">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="contactname" name="contactname"  class="form-control" value="@if($editVendor != Null){{$editVendor->contactname}} @endif" placeholder="Enter Contact Name">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="contactphone" name="contactphone"  class="form-control" value="@if($editVendor != Null){{$editVendor->contactphone}} @endif" placeholder="Enter Contact Phone Number ">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="contactemail" name="contactemail"  class="form-control" value="@if($editVendor != Null){{$editVendor->contactemail}} @endif" placeholder="Enter Contact Email">
                            ...
                            <div class="card-body">
                                <div class="card-body card-block">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="chairmanname" name="chairmanname"  class="form-control" value="@if($editVendor != Null){{$editVendor->chairmanname}} @endif" placeholder="Enter Chairman Phone Number">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="chairmanphone" name="chairmanphone"  class="form-control" value="@if($editVendor != Null){{$editVendor->chairmanphone}} @endif" placeholder="Enter Chairman Phone Number">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="chairmanemail" name="chairmanemail"  class="form-control" value="@if($editVendor != Null){{$editVendor->chairmanemail}} @endif" placeholder="Enter Chairman Email Address">
