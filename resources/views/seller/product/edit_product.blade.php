                   ...
                   <div class="tab-content pn br-n allcp-form theme-primary">
                               ...
                               <div class="col-md-4 ph10">
                                   <label for="model_number" class="field prepend-icon">
                                       <input type="text" name="model_number" id="model_number"
                                              class="gui-input"
                                              placeholder="Model Number" value="@if($editpro != Null) {{$editpro->model_number}} @endif" >
                       ...
                       <div id="tab1_3" class="tab-pane">
                             ...
                             <div class="col-md-6 ph10">
                                 <label for="unit_price" class="field prepend-icon">
                                     <input type="text" name="unit_price" id="unit_price"
                                            class="gui-input"
                                            placeholder="Unit Price..." value="{{$editpro->unit_price}}">
                             ...
                             <div class="col-md-6 ph10">
                                 <label for="price_for_optional_units" class="field prepend-icon">
                                     <input type="text" name="price_for_optional_units" id="price_for_optional_units"
                                            class="gui-input"
                                            placeholder="Price for optional units..." value="{{$editpro->price_for_optional_units}}">
                             ...
                             <div class="col-md-6 ph10">
                                 <label for="price_15_days" class="field prepend-icon">
                                     <input type="text" name="price_15_days" id="price_15_days"
                                            class="gui-input"
                                            placeholder="Price for 15 days..." value="{{$editpro->price_15_days}}">
                             ...
                             <div class="col-md-6 ph10">
                                 <label for="30_days_price" class="field prepend-icon">
                                     <input type="text" name="price_30_days" id="price_30_days"
                                            class="gui-input"
                                            placeholder="Price for 30 days..." value="{{$editpro->price_30_days}}">
                           ...
                           <div class="section row">
                             ...
                             name="credit_payment_details" placeholder="Credit Payment Details" value="{{$editpro->credit_payment_details}}">{{$editpro->credit_payment_details}}</textarea>
                           ...
                           <div class="section row">
                               <div class="col-md-12 ph10">
                                 <div class="section mb10">
                                     <label class="field prepend-icon">
                                         <textarea style="height: 160px;" class="gui-textarea br-light bg-light" id="comment"
                             name="optional_description" placeholder="Optional Description" value="{{$editpro->optional_description}}">{{$editpro->optional_description}}</textarea>
                       ...
                       <div id="tab1_4" class="tab-pane">
                           ...
                           <div class="section row">
                             ...
                             <div class="col-md-4 ph10">
                                 <label for="duration_within_state" class="field select">
                                     <select id="duration_within_state" name="duration_within_state">
                           ...
                           <div class="section mbn text-right">
                               <p class="text-right">
                                   <button class="btn btn-primary" type="submit"> <i class="fa fa-edit"></i>   Update product</button>
                               </p>
                           </div>
