...
<body>
    <div class="global-wrapper clearfix" id="global-wrapper">
        ...
        <link href="{{asset('public/frontend/css/star-rating.min.css')}}" media="all" rel="stylesheet" type="text/css" />
        <link href="{{asset('public/frontend/themes/krajee-svg/theme.css')}}" media="all" rel="stylesheet" type="text/css" />
        <link href="{{asset('public/frontend/themes/krajee-fa/theme.css')}}" media="all" rel="stylesheet" type="text/css" />
