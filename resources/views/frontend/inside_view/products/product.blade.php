            ...
            <div class="row">
                <div class="col-md-5">
                    <div class="product-page-product-wrap jqzoom-stage">
                        <div class="clearfix">
                            <a href="../img/products/1499633334.jpg" id="jqzoom" data-rel="gal-1">
                                <img src="../img/products/1499633334.jpg" alt="Image Alternative text" title="Image Title" />
                            </a>
                        </div>
                    </div>
                ...
                <div class="tab-content">
                    <div class="tab-pane fade in active" id="tab-1">
                        <div class="row row-eq-height product-overview-section">
                            <div class="col-md-6">
                                <img class="product-overview-img" src="../img/products/1499633334.jpg" alt="Image Alternative text" title="Image Title" />
                            </div>
                            <div class="col-md-6">
                ...
                <div class='col-md-3'>
                            <div class='product '>
                                ...
                                <div class='product-img-wrap'>
                                    <img class='product-img-primary' src='../img/products/1499633746.jpg' alt='Image Alternative text' title='Image Title' />
                                    <img class='product-img-alt' src='../img/products/1499633746.jpg' alt='Image Alternative text' title='Image Title' />
                                </div>
                            ...
                            <div class='product '>
                                <ul class='product-labels'></ul>
                                <div class='product-img-wrap'>
                                    <img class='product-img-primary' src='../img/vendorproduct/1509026351.jpg' alt='Image Alternative text' title='Image Title' />
                                    <img class='product-img-alt' src='../img/vendorproduct/1509026351.jpg' alt='Image Alternative text' title='Image Title' />
                                </div>
