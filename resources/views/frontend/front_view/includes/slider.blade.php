<div class="col-md-9">
                    <div class="owl-carousel owl-loaded owl-nav-dots-inner owl-carousel-curved" data-options='{"items":1,"loop":true}'>
                        <div class="owl-item">
                            <div class="slider-item" style="background-image:url({{asset('public/frontend/img/bg.jpg')}}); height:490px;">
                                <div class="slider-item-inner slider-item-inner-container">
                                    <div class="slider-item-caption-right slider-item-caption-white slider-item-caption-sm">
                                        <h4 class="slider-item-caption-title">Welding Tools</h4>
                                        <p class="slider-item-caption-desc">100% Guarantee</p><a class="btn btn-lg btn-ghost btn-white" href="#">Shop Now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="owl-item">
                            <div class="slider-item" style="background-color:#3D3D3D; height:490px;">
                                <div class="slider-item-inner slider-item-inner-container">
                                    ...
                                    <img class="slider-item-img-right" src="{{asset('public/frontend/img/test_slider/1-i.png')}}" alt="Image Alternative text" title="Image Title" style="top: 60%; width: 66%; right: -14%;" />
                                </div>
                            </div>
                        </div>
                        <div class="owl-item">
                            <div class="slider-item" style="background-color:#93282B; height:490px;">
                                <div class="slider-item-inner slider-item-inner-container">
                                    ...
                                    <img class="slider-item-img-right" src="{{asset('public/frontend/img/test_slider/3-i.png')}}" alt="Image Alternative text" title="Image Title" />
                                </div>
                            </div>
                        </div>
                    </div>
