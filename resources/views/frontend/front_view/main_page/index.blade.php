...
$ads_s_1 = App\HomeAdvert::where('ads_section', 1)
    ...
    ->select(DB::raw('home_adverts.*, categories.*, seller_products.*,seller_products.id as pro_id')) // Specify specifically
    ->orderBy('ads_id', 'desc')
    ->limit(3)
    ->get();
$today_f = App\HomeAdvert::where('ads_section', 2)
    ->join('seller_products','seller_products.id', '=', 'product_id')
    ->select(DB::raw('home_adverts.*, seller_products.*,seller_products.id as pro_id')) // Specify specifically
...
<div class="gap"></div>
            <div class="row" data-gutter="15">
                ...
                <div class="col-md-4">
                    <div class="banner" style="background-color:{{$ads->banner_color}}">
                        <a class="banner-link" href="{{url('/product-details/'.$ads->pro_id)}}"></a>
            ...
            <div class="owl-carousel owl-loaded owl-nav-out" data-options='{"items":5,"loop":true,"nav":true}'>
                    ...
                    <div class="owl-item">
                        <div class="product  owl-item-slide">
                            <div class="product-img-wrap">
                                <a href="{{url('/product-details/'.$product->pro_id)}}">
                            ...
                            <div class="product-caption">
                                ...
                                <div class="product-caption-price"><span class="product-caption-price-new">${{$product->unit_price}}</span>
                                    <a class="wishlist98" href="{{url('/add-to-wishlist/'.$product->pro_id)}}"><i class="fa fa-heart"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
             ...
             <div class="gap"></div>
        <div class="container">
            <h3 class="widget-title-lg">Best of Tech</h3><br>
            <div class="row" data-gutter="15">
              <!--  <div class="col-md-4">
                    <div class="product ">
                    ...
                    <div class="product ">
                        ...
                        <div class="product-img-wrap">
                          ...
                          @else
                              ...
                              <img class="product-img-alt" width="253" height="253" src="{{asset($ads->pro_image)}}" alt="{{$product->pro_name}}" title="{{$ads->pro_name}}" />
                          @endif
                        </div>
                        <a class="product-link" href="{{url('/product-details/'.$ads->pro_id)}}"></a>
                        <div class="product-caption">
                            <ul class="product-caption-rating">
                                <li class="rated"><i class="fa fa-star"></i>
                                </li>
                            ...
                            <div class="product-caption-price"><span class="product-caption-price-new">${{$ads->unit_price}}</span>
                            </div>
                            <ul class="product-caption-feature-list">
                                <li>Free Shipping</li>
                            </ul>
